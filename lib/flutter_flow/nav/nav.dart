        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'Main_Suppliers',
              path: 'mainSuppliers',
              builder: (context, params) => const MainSuppliersWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: 'Main_OrderManagement',
              path: 'mainOrderManagement',
              builder: (context, params) => const MainOrderManagementWidget(),
            ),
            FFRoute(
              name: 'Products',
              path: 'products',
            ...
            FFRoute(
              name: 'Materials',
              path: 'materials',
              builder: (context, params) => const MaterialsWidget(),
            ),
            FFRoute(
              name: 'Main_OrderManagementCopy',
              path: 'mainOrderPlanning',
              builder: (context, params) => const MainOrderManagementCopyWidget(),
            ),
            FFRoute(
              name: 'Main-ProductionDash',
              path: 'mainProductionDash',
              builder: (context, params) => const MainProductionDashWidget(),
            )
