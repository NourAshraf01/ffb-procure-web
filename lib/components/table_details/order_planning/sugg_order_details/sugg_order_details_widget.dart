...
import 'sugg_order_details_model.dart';
export 'sugg_order_details_model.dart';

class SuggOrderDetailsWidget extends StatefulWidget {
  const SuggOrderDetailsWidget({
    super.key,
  ...
  @override
  State<SuggOrderDetailsWidget> createState() => _SuggOrderDetailsWidgetState();
}

class _SuggOrderDetailsWidgetState extends State<SuggOrderDetailsWidget>
    with TickerProviderStateMixin {
  late SuggOrderDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SuggOrderDetailsModel());
