...
import 'strategy_options_model.dart';
export 'strategy_options_model.dart';

class StrategyOptionsWidget extends StatefulWidget {
  const StrategyOptionsWidget({
    super.key,
  ...
  @override
  State<StrategyOptionsWidget> createState() => _StrategyOptionsWidgetState();
}

class _StrategyOptionsWidgetState extends State<StrategyOptionsWidget>
    with TickerProviderStateMixin {
  late StrategyOptionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StrategyOptionsModel());
    ...
    _model.supplierEmailTextController2 ??= TextEditingController(
    ...
    _model.supplierNameTextController3 ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.material?.lotSize.toString(),
      'Default Email',
    ));
    _model.supplierNameFocusNode3 ??= FocusNode();

    _model.supplierEmailTextController3 ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.material?.strategy,
      'Default Email',
    ));
    _model.supplierEmailFocusNode3 ??= FocusNode();
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .supplierEmailTextController3,
                                                focusNode: _model
                                                    .supplierEmailFocusNode3,
                                                autofocus: false,
                                                readOnly:
                                                    _model.isEditable == false,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  labelText: 'Supply Strategy',
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                                          .labelMedium
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              if (_model.isEditable) {
                                _model.apiResultro5 = await BatteryAPIGroup
                                    .upsertSupplierCall
                                    .call();

                                if ((_model.apiResultro5?.succeeded ?? true)) {
