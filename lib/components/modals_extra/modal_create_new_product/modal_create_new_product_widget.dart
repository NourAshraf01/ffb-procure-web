...
import 'modal_create_new_product_model.dart';
export 'modal_create_new_product_model.dart';

class ModalCreateNewProductWidget extends StatefulWidget {
  const ModalCreateNewProductWidget({super.key});

  @override
  State<ModalCreateNewProductWidget> createState() =>
      _ModalCreateNewProductWidgetState();
}

class _ModalCreateNewProductWidgetState
    extends State<ModalCreateNewProductWidget> with TickerProviderStateMixin {
  late ModalCreateNewProductModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalCreateNewProductModel());
                                          ...
                                          child: Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: ((_model.priceTextController
                                                  ...
                                                  ? null
                                                  : () async {
                                                      _model.addToCatalogeItems(functions.addMaterialItem(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  _model.addProduct = await BatteryAPIGroup
                                      .createProductCall
                                      .call(
                                    description:
